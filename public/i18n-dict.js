...
window.FANBOX_DICT = {
  ...
  'Codex 桌面应用': 'Codex desktop app',
  '打开 Codex 桌面应用': 'Open Codex desktop app',
  ...
  '启用（更新 Claude Settings）': 'Enable (update Claude Settings)',
  '停用（更新 Claude Settings）': 'Disable (update Claude Settings)',
  '启用（更新 Codex config.toml，重启 Codex 后生效）': 'Enable (update Codex config.toml; restart Codex to apply)',
  '停用（更新 Codex config.toml，重启 Codex 后生效）': 'Disable (update Codex config.toml; restart Codex to apply)',
  ...
  '清空': 'Clear',
  '关闭 (Esc)': 'Close (Esc)',
  '前往文件或文件夹': 'Go to File or Folder',
  '文件或文件夹路径': 'File or folder path',
  '支持绝对路径、': 'Supports absolute paths, ',
  '，以及相对当前目录的路径': ', and paths relative to the current folder',
  '取消': 'Cancel',
  '前往': 'Go',
  '正在打开…': 'Opening…',
  '请输入文件或文件夹路径': 'Enter a file or folder path',
  '无法打开这个路径': 'Could not open this path',
